...
//for(j=1;j<=all_names.size();++j) {
                        ...
                        //    al   =request.getParameterValues(ch3);
                             // String name=request.getParameter(ch3);
//}                    //if (!name.isEmpty()) {
String[] values=request.getParameterValues("Professer");
                    %>
        <page size="legal"> 
       ...
       %> 
            ...
            <header >
                <div style="margin-left:35px; margin-right:0px; ">
                    <div style="margin-left:110px ;margin-right: 0px; margin-top: 10px;">
                     <img src="LOGO.png" style="height:55px;width:45px;">
                    </div>
                        <div style="margin-left:45px ;margin-right: 0px; margin-top: -60px;">   <center>  <font style="font-size:20px;"><b>GOVERNMENT POLYTECHNIC,NASHIK</b></font></center></div>
                    ...
                    <div style="margin-left:50px; margin-top:-20px;">
                        ...
                        <br><%
                              for( Professor_details professors  : all_names )  {
                                  ...
                                  if(k.equalsIgnoreCase( values[q])){%>
    ...
    <% }  %>             </table>
                   ...
                   <!-- <div style="float:left; margin-left:-240px;">-->
                        <ol type="1">
                            ...
                            <!-- 2nd instruction-->
                            <li><b>The last date for submitting the manuscript of question paper set is</b>&ensp;&ensp;&ensp; <u><b><%%></b></u>
                            </li>
                            <!-- /2rd instruction-->

...
<%@page import="dao.Typist_bill_fetch"%>
...
<%  Typist_bill_fetch namesDAO = new Typist_bill_fetch();
    List<Bill_of_Typist> all_names = namesDAO.getDetails();
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body"> <a href="print_typistbill_record.jsp">Click here to print Typist bill records</a>
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                             <% int i=0;
                             for(Bill_of_Typist names : all_names ) {if(se3.equalsIgnoreCase(names.getSes())){%>  
                             <td><%=++i%></td>
                           <td><%=names.getTyp_name()%> 
                           </td>

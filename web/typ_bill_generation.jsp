...
%>  
  ...
  var tds = document.getElementById('dataTable').getElementsByTagName('td');
                ...
                document.getElementById('dataTable').innerHTML +=  '<tr><td><b>Total Q.paper Qty</b> </td><td></td><td>'+ sum_sets +'</td><td><td></td><td></td><td></td> </tr>';
                 document.getElementById('dataTable').innerHTML +=  '<tr><td><b>Total Amount</b> </td><td></td><td></td><td><td></td><td></td><td>'+ sum +'</td> </tr>' ;
        </script>

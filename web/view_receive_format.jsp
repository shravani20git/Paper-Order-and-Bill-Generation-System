                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Receive Paper Orders Format </strong>
                        </div>
                        <div class="card-body"> <a href="print_receive_format.jsp">Click here to print paper order  records of receive format</a>
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <td><%=name.getCode() %></td>
                      <td><%=name.getSes()    %></td>
                    <td><%=name.getFormat()  %></td>
                    <td><%=name.getPapersets()  %></td>  <% Date d =name.getTdate();
                   String  dt= sdf2.format(d);%>   <td><%=dt%></td>  
